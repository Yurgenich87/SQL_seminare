...
SELECT firstname, lastname, post, seniority, salary, age FROM mydatabase.staff
ORDER BY salary ASC;
...
SELECT COUNT(DISTINCT post) AS specializations_count
FROM staff;
...
SELECT date_activity, COUNT(DISTINCT id) AS employee_count
FROM activity_staff
